...
flirt -in $SDIR/$SFILE -ref $REFERENCE -out $SDIR/$OUTFILE -omat $SDIR/$MATFILE -bins 256 -cost corratio -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12  -interp trilinear
